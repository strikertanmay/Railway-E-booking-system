...
if(isset($_POST['submit']))
{
    ...
    $statement = $db->prepare("INSERT INTO train_status (TrainNumber,available_Date,booked_seats,available_seats) VALUES (?,?,?,?)");
			  ...
			  <div class="forminput">
				<form style="margin-top:25px;" name="adform" action="" onsubmit="return validate_from()" method="post" class="form-horizontal" >
				  <div class="form-group">
					  <label  class="col-sm-3 control-label" for="sel1" style="color:black; font-size:1.6rem; padding:5px;">Select Train Name</label>
					  <div class="col-sm-8" >
				  ...
				  <div class="form-group">
					<label  class="col-sm-3 control-label" style="color:black; font-size:1.6rem; padding:5px;">Available Date</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputdate3" placeholder="date : 2016-10-01" name="date">
					</div>
				  </div>
				  <div class="form-group">
					<label  class="col-sm-3 control-label" style="color:black; font-size:1.6rem; padding:5px;">Number of seats</label>
					<div class="col-sm-8">
