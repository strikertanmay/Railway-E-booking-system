...
if(isset($_POST['submit']))
{
 ...
 $statement = $db->prepare("INSERT INTO routes (TrainNumber,StopNumber,StationName,ArrivalTime,DepartureTime)VALUES(?,?,?,?,?)");
...
function validate_from()
			{
				...
				<form class="form-horizontal" name="adform" action="" onsubmit="return validate_from()" method="post">
				  <div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label" style="color:black; font-size:1.6rem; padding:5px;">Train Number</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputEmail3" name="train_id" placeholder="Train_ID">
					</div>
				  </div>
				  <div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label" style="color:black; font-size:1.6rem; padding:5px;">Stop Number</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputPassword3" name="stop_number" placeholder="Stop_number">
					</div>
				  </div>
				 <div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label" style="color:black; font-size:1.6rem; padding:5px;">Station Name</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputPassword3" name="station_id" placeholder="Station_ID">
					</div>
				  </div>
				 <div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label" style="color:black; font-size:1.6rem; padding:5px;">Arrival Time</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputPassword3" name="arrival_time" placeholder="Arrival_time">
					</div>
				  </div>
				  <div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label" style="color:black; font-size:1.6rem; padding:5px;">Departure Time</label>
					<div class="col-sm-8">
