			  ...
			  <div class="forminput">
				<form style="margin-top:25px;" name="adform" action="tickets.php" onsubmit="return validate_from()" method="post" class="form-horizontal" >
				  <div class="form-group">
					<label  class="col-sm-3 control-label" style="color:black; font-size:1.4rem; padding:3px;">Passenger Name</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputEmail3" placeholder="Name" name="pname">
					</div>
				  </div>
				  <div class="form-group">
					<label  class="col-sm-3 control-label" style="color:black; font-size:1.4rem; padding:3px;">Train Date</label>
					<div class="col-sm-8">
					  <input type="date" class="form-control" id="inputdate3" <?php if(!empty($_POST['availdate'])){ ?> value="<?=$_POST['availdate']?>" <?php } ?> name="date"/>
					</div>
				  </div>
				  <div class="form-group">
					<label  class="col-sm-3 control-label" style="color:black; font-size:1.4rem; padding:3px;">Number of seats</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputEmail3" placeholder="Number of seat_no" name="seat_no">
					</div>
				  </div>
				  <div class="form-group">
					  <label  class="col-sm-3 control-label" for="sel1" style="color:black; font-size:1.4rem; padding:3px;">Select Train Name</label>
					  <div class="col-sm-8" >
