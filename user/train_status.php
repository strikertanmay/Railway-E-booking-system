...
?>		  <div class = "conatainer">
		<div class="forminput">
			<table class="table tablebg" style="color:black; font-size:1.5rem; padding:5px;">
					<tr>
						<th>TrainNumber</th>
			...
			<div class = "container">
				<form style="margin-top:300px;" class="form-horizontal forminput" action="" method="post">
				  <div class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label" style="color:black; font-size:1.5rem; padding:5px;">Train Number</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputEmail3" placeholder="Train No" name="train_id">
					</div>
				  </div>
				  <div class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label" style="color:black; font-size:1.5rem; padding:5px;">Journey Date</label>
					<div class="col-sm-8">
