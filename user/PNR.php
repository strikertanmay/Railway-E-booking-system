...
<div class="container">
			  <div class="forminput">
				...
				<form class="form-horizontal action="" method="post" ">
				  <div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label" style="color:black; font-size:1.4rem; padding:3px;">PNR NO</label>
					<div class="col-sm-8">
		...
		?>		
				...
				<table class="table tablebg" style="color:black; font-size:1.8rem; text-align:center;">
					<tr>
