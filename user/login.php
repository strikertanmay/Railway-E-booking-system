			  ...
			  <div class="forminput" style="text-align:center; margin-top:100px;">
				<form class="form-horizontal" method="post" action="" >
				  <div class="form-group">
					...
					<label  class="col-sm-3 control-label" style="color:black; font-size:2rem; padding:5px;">UserName</label>
					<div class="col-sm-8">
					  <input type="text" class="form-control" id="inputEmail3" placeholder="Username" name="username">
					  <?php if(isset($_POST['form_login']) && $flag1==1){ ?><label style="color:black; font-size:2rem; "><?php echo $error_message; } ?></label>
					</div>
				  </div>
				  <div class="form-group">
					<label for="inputPassword3" class="col-sm-3 control-label" style="color:black; font-size:2rem; ">Password</label>
					<div class="col-sm-8">
